 ...
 * @author SteveW
 */
public class SingleJustificationTester 
{
    public static void main(String[] args) {
        try 
        {
            ...
            String inputKnowledgeBasePath = "src/test/java/org/defeasiblejustification/classicaljustifiaction/classicalJustificationTestExample4.txt";
